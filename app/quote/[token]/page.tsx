            ...
            {booking.quoteResponse === 'accepted' ? (
              <>
                <div className="bg-green-50 border border-green-200 rounded-2xl p-6 text-center">
                  ...
                  <p className="text-sm text-gray-400 mt-3">Questions? Call <a href="tel:+17123265651" className="text-green-600 font-medium">(712) 326-5651</a></p>
                </div>
              ...
              <>
                <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 text-center">
                  ...
                  <h1 className="text-xl font-bold text-gray-900 mb-1">Quote Declined</h1>
                  <p className="text-gray-500 text-sm">No problem — feel free to reach out if you have questions.</p>
                  <p className="text-sm text-gray-400 mt-3">Call <a href="tel:+17123265651" className="text-green-600 font-medium">(712) 326-5651</a></p>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                  ...
                  {hasLineItems ? (
                    <table className="w-full text-sm">
                      ...
                      <tfoot className="border-t border-gray-200">
                        ...
                        <tr className="bg-gray-50 border-t-2 border-gray-100">
                          <td colSpan={3} className="px-5 py-3 text-right font-bold text-gray-900">Total</td>
                          <td className="px-5 py-3 text-right text-2xl font-bold text-gray-500">${(booking.grandTotal ?? booking.quoteAmount).toFixed(2)}</td>
                        </tr>
                      </tfoot>
                    </table>
                  ) : (
                    <div className="px-5 py-4 space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-gray-500 text-sm">Total</span>
                        <span className="text-2xl font-bold text-gray-500">${booking.quoteAmount.toFixed(2)}</span>
                      </div>
                    </div>
                  )}
                </div>
